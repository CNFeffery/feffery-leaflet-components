...
export ''_leafletmigrationlayer

"""
    ''_leafletmigrationlayer(;kwargs...)

A LeafletMigrationLayer component.
...
"""
function ''_leafletmigrationlayer(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("''_leafletmigrationlayer", "LeafletMigrationLayer", "feffery_leaflet_components", available_props, wild_props; kwargs...)
end
