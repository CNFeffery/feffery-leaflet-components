...
function __init__()
    ...
    external_url = "https://unpkg.com/feffery_leaflet_components@0.2.3/feffery_leaflet_components/feffery_leaflet_components.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_leaflet_components@0.2.3/feffery_leaflet_components/feffery_leaflet_components.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
